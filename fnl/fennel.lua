package.preload["fennel.repl"] = package.preload["fennel.repl"] or function(...)
  ...
  local function default_on_error(errtype, err, lua_source)
    local function _593_()
      local _592_0 = errtype
      if (_592_0 == "Lua Compile") then
        return ("Bad code generated - likely a bug with the compiler:\n" .. "--- Generated Lua Start ---\n" .. lua_source .. "--- Generated Lua End ---\n")
      elseif (_592_0 == "Runtime") then
  ...
  local function splice_save_locals(env, lua_source, scope)
    ...
    local function _602_()
      local _600_0, _601_0 = lua_source:match("^(.*)[\n ](return .*)$")
      if ((nil ~= _600_0) and (nil ~= _601_0)) then
        local body = _600_0
        local _return = _601_0
  ...
  local function reload(module_name, env, on_values, on_error)
    local _615_0, _616_0 = pcall(specials["load-code"]("return require(...)", env), module_name)
    if ((_615_0 == true) and (nil ~= _616_0)) then
      local old = _616_0
      local _ = nil
      ...
      return on_values({"ok"})
    elseif ((_615_0 == false) and (nil ~= _616_0)) then
      local msg = _616_0
  ...
  local function run_command(read, on_error, f)
    local _624_0, _625_0, _626_0 = pcall(read)
    if ((_624_0 == true) and (_625_0 == true) and (nil ~= _626_0)) then
      local val = _626_0
      return f(val)
    elseif (_624_0 == false) then
  ...
  local function apropos_2a(pattern, tbl, prefix, seen, names)
    for name, subtbl in pairs(tbl) do
      if (("string" == type(name)) and (package ~= subtbl)) then
        local _630_0 = type(subtbl)
        if (_630_0 == "function") then
          if ((prefix .. name)):match(pattern) then
            table.insert(names, (prefix .. name))
          end
        elseif (_630_0 == "table") then
    ...
    for _, path in ipairs(apropos(".*")) do
      ...
      do
        ...
        if ("function" == type(tgt)) then
          local _641_0 = (compiler.metadata):get(tgt, "fnl/docstring")
          if (nil ~= _641_0) then
            local docstr = _641_0
  ...
  local function resolve(identifier, _648_0, scope)
    local _649_ = _648_0
    local env = _649_
    local ___replLocals___ = _649_["___replLocals___"]
    local e = nil
    local function _650_(_241, _242)
      return (___replLocals___[scope.unmanglings[_242]] or env[_242])
    end
    e = setmetatable({}, {__index = _650_})
    local _651_0, _652_0 = pcall(compiler["compile-string"], tostring(identifier), {scope = scope})
    if ((_651_0 == true) and (nil ~= _652_0)) then
      local code = _652_0
  ...
  commands.find = function(env, read, on_values, on_error, scope)
    local function _654_(_241)
      local _655_0 = nil
      do
        local _656_0 = utils["sym?"](_241)
        if (nil ~= _656_0) then
          local _657_0 = resolve(_656_0, env, scope)
          if (nil ~= _657_0) then
            _655_0 = debug.getinfo(_657_0)
          else
            _655_0 = _657_0
          end
        else
      ...
      if ((_G.type(_655_0) == "table") and (nil ~= _655_0.linedefined) and (nil ~= _655_0.short_src) and (nil ~= _655_0.source) and (_655_0.what == "Lua")) then
        local line = _655_0.linedefined
        local src = _655_0.short_src
        local source = _655_0.source
        local fnlsrc = nil
        do
          local _660_0 = compiler.sourcemap
          if (nil ~= _660_0) then
            _660_0 = _660_0[source]
          end
          if (nil ~= _660_0) then
            _660_0 = _660_0[line]
          end
  ...
  local function load_plugin_commands(plugins)
    for _, plugin in ipairs((plugins or {})) do
      for name, f in pairs(plugin) do
        local _670_0 = name:match("^repl%-command%-(.*)")
        if (nil ~= _670_0) then
          local cmd_name = _670_0
  ...
  local function run_command_loop(input, read, loop, env, on_values, on_error, scope, chars)
    ...
    do
      local _672_0 = commands[command_name]
      if (nil ~= _672_0) then
        local command = _672_0
  ...
  local function repl(_3foptions)
    ...
    local _681_ = utils.copy(_3foptions)
    local opts = _681_
    local _3ffennelrc = _681_["fennelrc"]
    local _ = nil
    opts.fennelrc = nil
    _ = nil
    ...
    local function _683_(parser_state)
      local c = byte_stream(parser_state)
      table.insert(chars, c)
      return c
    end
    read, reset = parser.parser(_683_)
    ...
    if opts.registerCompleter then
      local function _686_()
        ...
        local function _687_(...)
          return completer(env, _685_0, ...)
        end
        return _687_
      end
      opts.registerCompleter(_686_())
    end
    ...
    local function loop()
      ...
      elseif command_3f(src_string) then
        ...
        if not_eof_3f then
          do
            local _691_0, _692_0 = nil, nil
            local function _693_()
              opts["source"] = src_string
              return opts
            end
            _691_0, _692_0 = pcall(compiler.compile, x, _693_())
            if ((_691_0 == false) and (nil ~= _692_0)) then
              local msg = _692_0
              clear_stream()
              on_error("Compile", msg)
            elseif ((_691_0 == true) and (nil ~= _692_0)) then
              local src = _692_0
              local src0 = nil
              if save_locals_3f then
              ...
              local _695_0, _696_0 = pcall(specials["load-code"], src0, env)
              if ((_695_0 == false) and (nil ~= _696_0)) then
                local msg = _696_0
                clear_stream()
                on_error("Lua Compile", msg, src0)
              elseif (true and (nil ~= _696_0)) then
                local _1 = _695_0
                local chunk = _696_0
...
package.preload["fennel.specials"] = package.preload["fennel.specials"] or function(...)
  ...
  local function wrap_env(env)
    ...
    local function _409_(_, key, value)
      if utils["string?"](key) then
    ...
    local function _411_()
      local function putenv(k, v)
        ...
        if utils["string?"](k) then
          _412_ = compiler["global-unmangling"](k)
        else
          _412_ = k
        end
        return _412_, v
    ...
    return setmetatable({}, {__index = _407_, __newindex = _409_, __pairs = _411_})
  end
  local function current_global_names(_3fenv)
    local mt = nil
    do
      local _414_0 = getmetatable(_3fenv)
      if ((_G.type(_414_0) == "table") and (nil ~= _414_0.__pairs)) then
        local mtpairs = _414_0.__pairs
        local tbl_14_ = {}
  ...
  local function load_code(code, _3fenv, _3ffilename)
    ...
    local _417_0, _418_0 = rawget(_G, "setfenv"), rawget(_G, "loadstring")
    if ((nil ~= _417_0) and (nil ~= _418_0)) then
      local setfenv = _417_0
      local loadstring = _418_0
  ...
  local function doc_2a(tgt, name)
    if not tgt then
      ...
      if ((type(tgt) == "function") or ((type(mt) == "table") and (type(mt.__call) == "function"))) then
        ...
        return string.format("(%s%s%s)\n  %s", name, _420_, arglist, docstring)
      else
  ...
  local function compile_value(v)
    ...
    local chunk = {}
    local _431_ = compiler.compile1(v, scope, chunk, opts)
    local _432_ = _431_[1]
    local v0 = _432_[1]
    return v0
  end
  ...
  local function insert_arglist(meta, arg_list)
    ...
    table.insert(meta, ("{" .. table.concat(utils.map(arg_list, _434_), ", ") .. "}"))
    return meta
  end
  ...
  local function get_fn_name(ast, scope, fn_name, multi)
    if (fn_name and (fn_name[1] ~= "nil")) then
      local _437_
      if not multi then
        _437_ = compiler["declare-local"](fn_name, {}, scope, ast)
      else
        _437_ = compiler["symbol-to-expression"](fn_name, scope)[1]
      end
      return _437_, not multi, 3
    else
      return nil, true, 2
    end
  end
  local function compile_named_fn(ast, f_scope, f_chunk, parent, index, fn_name, local_3f, arg_name_list, f_metadata)
    ...
    local _440_
    if local_3f then
      _440_ = "local function %s(%s)"
    else
      _440_ = "%s = function(%s)"
    end
    compiler.emit(parent, string.format(_440_, fn_name, table.concat(arg_name_list, ", ")), ast)
  ...
  SPECIALS.fn = function(ast, scope, parent)
    local f_scope = nil
    do
      local _447_0 = compiler["make-scope"](scope)
      _447_0["vararg"] = false
      f_scope = _447_0
    end
    local f_chunk = {}
  ...
  SPECIALS.lua = function(ast, _, parent)
    ...
    local _452_
    do
      local _451_0 = utils["sym?"](ast[2])
      if (nil ~= _451_0) then
        _452_ = tostring(_451_0)
      else
        _452_ = _451_0
      end
    end
    ...
    local _456_
    do
      local _455_0 = utils["sym?"](ast[3])
      if (nil ~= _455_0) then
        _456_ = tostring(_455_0)
      else
        _456_ = _455_0
      end
    end
  ...
  local function dot(ast, scope, parent)
    ...
    local len = #ast
    local _459_ = compiler.compile1(ast[2], scope, parent, {nval = 1})
    local lhs = _459_[1]
    if (len == 2) then
      return tostring(lhs)
    else
      ...
      for i = 3, len do
        ...
        if (utils["string?"](index) and utils["valid-lua-identifier?"](index)) then
          ...
          local _460_ = compiler.compile1(index, scope, parent, {nval = 1})
          local index0 = _460_[1]
  ...
  local function disambiguate_3f(rootstr, parent)
    local function _469_()
      local _468_0 = get_prev_line(parent)
      if (nil ~= _468_0) then
        local prev_line = _468_0
        return prev_line:match("%)$")
      end
    end
    return (rootstr:match("^{") or _469_())
  end
  SPECIALS.tset = function(ast, scope, parent)
    ...
    local keys = {}
    for i = 3, (#ast - 1) do
      local _471_ = compiler.compile1(ast[i], scope, parent, {nval = 1})
      local key = _471_[1]
  ...
  local function compile_until(condition, scope, chunk)
    if condition then
      local _480_ = compiler.compile1(condition, scope, chunk, {nval = 1})
      local condition_lua = _480_[1]
  ...
  local function method_call(ast, scope, parent)
    ...
    local _486_ = compiler.compile1(ast[2], scope, parent, {nval = 1})
    local target = _486_[1]
    local args = {}
    for i = 4, #ast do
      local subexprs = nil
      local _487_
      ...
      subexprs = compiler.compile1(ast[i], scope, parent, {nval = _487_})
  ...
  local function maybe_short_circuit_protect(ast, i, name, _496_0)
    local _497_ = _496_0
    local mac = _497_["macros"]
  ...
  local function arithmetic_special(name, zero_arity, unary_prefix, ast, scope, parent)
    ...
    if (_500_0 == 0) then
      ...
      return utils.expr(_501_, "literal")
    elseif (_500_0 == 1) then
  ...
  local function define_arithmetic_special(name, zero_arity, unary_prefix, _3flua_name)
    local _505_
    do
      local _504_0 = (_3flua_name or name)
      local function _506_(...)
        return arithmetic_special(_504_0, zero_arity, unary_prefix, ...)
      end
      _505_ = _506_
    end
    SPECIALS[name] = _505_
  ...
  local function bitop_special(native_name, lib_name, zero_arity, unary_prefix, ast, scope, parent)
    if (#ast == 1) then
      ...
      for i = 2, len do
        ...
        subexprs = compiler.compile1(ast[i], scope, parent, {nval = _507_})
        utils.map(subexprs, tostring, operands)
      end
      if (#operands == 1) then
  ...
  local function native_comparator(op, _514_0, scope, parent)
    local _515_ = _514_0
    local _ = _515_[1]
    local lhs_ast = _515_[2]
    local rhs_ast = _515_[3]
    local _516_ = compiler.compile1(lhs_ast, scope, parent, {nval = 1})
    local lhs = _516_[1]
    local _517_ = compiler.compile1(rhs_ast, scope, parent, {nval = 1})
    local rhs = _517_[1]
  ...
  local function make_compiler_env(ast, scope, parent, _3fopts)
    local provided = nil
    do
      local _528_0 = (_3fopts or utils.root.options)
      if ((_G.type(_528_0) == "table") and (_528_0["compiler-env"] == "strict")) then
        provided = safe_compiler_env()
      elseif ((_G.type(_528_0) == "table") and (nil ~= _528_0.compilerEnv)) then
        local compilerEnv = _528_0.compilerEnv
        provided = compilerEnv
      elseif ((_G.type(_528_0) == "table") and (nil ~= _528_0["compiler-env"])) then
        local compiler_env = _528_0["compiler-env"]
  ...
  local _536_ = _534_(...)
  local dirsep = _536_[1]
  local pathsep = _536_[2]
  local pathmark = _536_[3]
  ...
  local function search_module(modulename, _3fpathstring)
    ...
    local function try_path(path)
      ...
      local _537_0 = (io.open(filename) or io.open(filename2))
      if (nil ~= _537_0) then
        local file = _537_0
        file:close()
        return filename
    ...
    local function find_in_path(start, _3ftried_paths)
      local _539_0 = fullpath:match(pattern, start)
      if (nil ~= _539_0) then
        local path = _539_0
        local _540_0, _541_0 = try_path(path)
        if (nil ~= _540_0) then
          local filename = _540_0
          return filename
        elseif ((_540_0 == nil) and (nil ~= _541_0)) then
          local error = _541_0
          local function _543_()
            local _542_0 = (_3ftried_paths or {})
            table.insert(_542_0, error)
            return _542_0
          end
          return find_in_path((start + #path + 1), _543_())
        end
      else
        local _ = _539_0
  ...
  local function make_searcher(_3foptions)
    local function _548_(module_name)
      local opts = utils.copy(utils.root.options)
      for k, v in pairs((_3foptions or {})) do
        opts[k] = v
      end
      opts["module-name"] = module_name
      local _549_0, _550_0 = search_module(module_name)
      if (nil ~= _549_0) then
        local filename = _549_0
        local function _551_(...)
          return utils["fennel-module"].dofile(filename, opts, ...)
        end
        return _551_, filename
      elseif ((_549_0 == nil) and (nil ~= _550_0)) then
        local error = _550_0
        return error
      end
    end
  ...
  local function fennel_macro_searcher(module_name)
    local opts = nil
    do
      local _553_0 = utils.copy(utils.root.options)
      _553_0["module-name"] = module_name
      _553_0["env"] = "_COMPILER"
      _553_0["requireAsInclude"] = false
      _553_0["allowedGlobals"] = nil
      opts = _553_0
    end
    local _554_0 = search_module(module_name, utils["fennel-module"]["macro-path"])
    if (nil ~= _554_0) then
      ...
      return _555_, filename
    end
  end
  local function lua_macro_searcher(module_name)
    local _560_0 = search_module(module_name, package.path)
    if (nil ~= _560_0) then
      ...
      do
        ...
        code = close_handlers_10_(_G.xpcall(_562_, (package.loaded.fennel or debug).traceback))
      end
  ...
  local function search_macro_module(modname, n)
    local _564_0 = macro_searchers[n]
    if (nil ~= _564_0) then
      local f = _564_0
      local _565_0, _566_0 = f(modname)
      if ((nil ~= _565_0) and true) then
        local loader = _565_0
        local _3ffilename = _566_0
  ...
  local function _570_(modname)
    ...
    return (macro_loaded[modname] or sandbox_fennel_module(modname) or _571_())
  end
  safe_require = _570_
  ...
  local function resolve_module_name(_572_0, _scope, _parent, opts)
    local _573_ = _572_0
    local second = _573_[2]
    local filename = _573_["filename"]
  ...
  local function include_path(ast, opts, path, mod, fennel_3f)
    ...
    do
      ...
      src = close_handlers_10_(_G.xpcall(_579_, (package.loaded.fennel or debug).traceback))
    end
  ...
  SPECIALS.include = function(ast, scope, parent, opts)
    ...
    local modexpr = nil
    do
      local _582_0, _583_0 = pcall(resolve_module_name, ast, scope, parent, opts)
      if ((_582_0 == true) and (nil ~= _583_0)) then
        local modname = _583_0
    ...
    if ((modexpr.type ~= "literal") or ((modexpr[1]):byte() ~= 34)) then
      ...
      local function _587_()
        local _586_0 = search_module(mod)
        if (nil ~= _586_0) then
          local fennel_path = _586_0
      ...
      res = ((utils["member?"](mod, (utils.root.options.skipInclude or {})) and opts.fallback(modexpr, true)) or include_circular_fallback(mod, modexpr, opts.fallback, ast) or utils.root.scope.includes[mod] or _587_())
...
package.preload["fennel.compiler"] = package.preload["fennel.compiler"] or function(...)
  ...
  local function assert_compile(condition, msg, ast, _3ffallback_ast)
    if not condition then
      local _254_ = (utils.root.options or {})
      local error_pinpoint = _254_["error-pinpoint"]
      local source = _254_["source"]
      local unfriendly = _254_["unfriendly"]
      local ast0 = nil
  ...
  local function serialize_string(str)
    ...
    return string.gsub(string.gsub(string.format("%q", str), ".", serialize_subst), "[\128-\255]", _259_)
  end
  local function global_mangling(str)
    if utils["valid-lua-identifier?"](str) then
      ...
      return ("__fnl_global__" .. str:gsub("[^%w]", _260_))
    end
  end
  local function global_unmangling(identifier)
    local _262_0 = string.match(identifier, "^__fnl_global__(.*)$")
    if (nil ~= _262_0) then
      local rest = _262_0
      local _263_0 = nil
      ...
      _263_0 = string.gsub(rest, "_[%da-f][%da-f]", _264_)
      return _263_0
    else
      local _ = _262_0
      return identifier
  ...
  local function local_mangling(str, scope, ast, _3ftemp_manglings)
    ...
    mangling = string.gsub(string.gsub(raw, "-", "_"), "[^%w_]", _268_)
  ...
  local function autogensym(base, scope)
    local _272_0 = utils["multi-sym?"](base)
    if (nil ~= _272_0) then
      local parts = _272_0
      ...
      return (scope.autogensyms[base] or _273_())
    end
  end
  ...
  local function flatten_chunk(file_sourcemap, chunk, tab, depth)
    if chunk.leaf then
      local _287_ = utils["ast-source"](chunk.ast)
      local filename = _287_["filename"]
      local line = _287_["line"]
      ...
      do
        ...
        if (_288_0 == true) then
          tab0 = "  "
        elseif (_288_0 == false) then
          tab0 = ""
        elseif (_288_0 == tab) then
          tab0 = tab
        elseif (_288_0 == nil) then
          tab0 = ""
        else
        tab0 = nil
        end
  ...
  local function find_macro(ast, scope)
    local macro_2a = nil
    do
      local _310_0 = utils["sym?"](ast[1])
      if (_310_0 ~= nil) then
        local _311_0 = tostring(_310_0)
        if (_311_0 ~= nil) then
          macro_2a = scope.macros[_311_0]
        else
          macro_2a = _311_0
        end
      else
  ...
  local function propagate_trace_info(_315_0, _index, node)
    local _316_ = _315_0
    local byteend = _316_["byteend"]
    local bytestart = _316_["bytestart"]
    local filename = _316_["filename"]
    local line = _316_["line"]
    do
  ...
  local function macroexpand_2a(ast, scope, _3fonce)
    ...
    if utils["list?"](ast) then
      _322_0 = find_macro(ast, scope)
    else
    _322_0 = nil
    end
    if (_322_0 == false) then
      return ast
    elseif (nil ~= _322_0) then
      local macro_2a = _322_0
      ...
      ok, transformed = xpcall(_324_, _325_())
      local function _326_(...)
        return propagate_trace_info(ast, ...)
      end
      utils["walk-tree"](transformed, comp(_326_, quote_literal_nils))
  ...
  local function compile_function_call(ast, scope, parent, opts, compile1, len)
    ...
    for i = 2, len do
      ...
      subexprs = compile1(ast[i], scope, parent, {nval = _332_})
  ...
  local function compile_varg(ast, scope, parent, opts)
    ...
    if scope.hashfn then
      ...
      _337_ = "unexpected vararg"
    end
    assert_compile(scope.vararg, _337_, ast)
  ...
  local function serialize_number(n)
    local _340_0 = string.gsub(tostring(n), ",", ".")
    return _340_0
  end
  local function compile_scalar(ast, _scope, parent, opts)
    local serialize = nil
    do
      local _341_0 = type(ast)
      if (_341_0 == "nil") then
        serialize = tostring
      elseif (_341_0 == "boolean") then
        serialize = tostring
      elseif (_341_0 == "string") then
        serialize = serialize_string
      elseif (_341_0 == "number") then
  ...
  local function compile_table(ast, scope, parent, opts, compile1)
    local function escape_key(k)
      if ((type(k) == "string") and utils["valid-lua-identifier?"](k)) then
        ...
        local _343_ = compile1(k, scope, parent, {nval = 1})
        local compiled = _343_[1]
    ...
    do
      ...
      for k, v in utils.stablepairs(ast) do
        local val_19_ = nil
        if not keys[k] then
          local _346_ = compile1(ast[k], scope, parent, {nval = 1})
          local v0 = _346_[1]
  ...
  local function destructure(to, from, ast, scope, parent, opts)
    local opts0 = (opts or {})
    local _350_ = opts0
    local declaration = _350_["declaration"]
    local forceglobal = _350_["forceglobal"]
    local forceset = _350_["forceset"]
    local isvar = _350_["isvar"]
    local symtype = _350_["symtype"]
    ...
    local function destructure_kv_rest(s, v, left, excluded_keys, destructure1)
      ...
      exclude_str = table.concat(_363_, ", ")
    ...
    local function destructure_table(left, rightexprs, top_3f, destructure1)
      ...
      do
        local _365_0 = nil
        if top_3f then
          _365_0 = exprs1(compile1(from, scope, parent))
        else
          _365_0 = exprs1(rightexprs)
        end
        if (_365_0 == "") then
          right = "nil"
        elseif (nil ~= _365_0) then
          local right0 = _365_0
          right = right0
        else
        right = nil
  ...
  local function compile_stream(strm, options)
    ...
    local vals = {}
    local chunk = {}
    local _378_ = utils.root
    _378_["set-reset"](_378_)
  ...
  local function traceback_frame(info)
    ...
    elseif (info.what == "C") then
      ...
      if (info.what == "Lua") then
        ...
        return string.format("  %s:%d: in function %s", info.short_src, info.currentline, _387_())
  ...
  local function traceback(_3fmsg, _3fstart)
    ...
    if ((msg:find("^%g+:%d+:%d+ Compile error:.*") or msg:find("^%g+:%d+:%d+ Parse error:.*")) and not utils["debug-on?"]("trace")) then
      ...
      while not done_3f do
        do
          local _391_0 = debug.getinfo(level, "Sln")
          if (_391_0 == nil) then
            done_3f = true
          elseif (nil ~= _391_0) then
            local info = _391_0
  ...
  local function do_quote(form, scope, parent, runtime_3f)
    ...
    elseif utils["list?"](form) then
      ...
      mapped = utils.kvmap(form, entry_transform(_399_, q))
      local filename = nil
      if form.filename then
        filename = string.format("%q", form.filename)
      else
    ...
    elseif utils["sequence?"](form) then
      ...
      return string.format("setmetatable({%s}, {filename=%s, line=%s, sequence=%s})", mixed_concat(mapped, ", "), filename, _402_, "(getmetatable(sequence()))['sequence']")
    elseif (type(form) == "table") then
      ...
      return string.format("setmetatable({%s}, {filename=%s, line=%s})", mixed_concat(mapped, ", "), filename, _405_())
...
package.preload["fennel.friend"] = package.preload["fennel.friend"] or function(...)
  ...
  local function assert_compile(condition, msg, ast, source, opts)
    if not condition then
      local _189_ = utils["ast-source"](ast)
      local col = _189_["col"]
...
package.preload["fennel.parser"] = package.preload["fennel.parser"] or function(...)
  ...
  local function granulate(getchunk)
    ...
    local function _191_(parser_state)
      if not done_3f then
        if (index <= #c) then
          ...
          local _192_0 = getchunk(parser_state)
          local function _193_()
            local char = _192_0
            return (char ~= "")
          end
          if ((nil ~= _192_0) and _193_()) then
            local char = _192_0
            c = char
            index = 2
            return c:byte()
  ...
  local function parser_fn(getbyte, filename, _201_0)
    local _202_ = _201_0
    local options = _202_
    local comments = _202_["comments"]
    local source = _202_["source"]
    local unfriendly = _202_["unfriendly"]
    local stack = {}
    ...
    local function whitespace_3f(b)
      local function _209_()
        local _208_0 = options.whitespace
        if (nil ~= _208_0) then
          _208_0 = _208_0[b]
        end
        return _208_0
      end
      return ((b == 32) or ((9 <= b) and (b <= 13)) or _209_())
    end
    ...
    local function parse_stream()
      ...
      local function dispatch(v)
        local _213_0 = stack[#stack]
        if (_213_0 == nil) then
          retval, done_3f, whitespace_since_dispatch = v, true, false
          return nil
        elseif ((_G.type(_213_0) == "table") and (nil ~= _213_0.prefix)) then
          local prefix = _213_0.prefix
          local source0 = nil
          do
            local _214_0 = table.remove(stack)
            set_source_fields(_214_0)
            source0 = _214_0
          end
      ...
      local function badend()
        ...
        return parse_error(string.format("expected closing delimiter%s %s", _216_, string.char(unpack(accum))))
      end
      ...
      local function parse_comment(b, contents)
        if (b and (10 ~= b)) then
          ...
          return parse_comment(getb(), _219_())
      ...
      local function add_comment_at(comments0, index, node)
        local _222_0 = comments0[index]
        if (nil ~= _222_0) then
          local existing = _222_0
      ...
      local function parse_string_loop(chars, b, state)
        ...
        local state0 = nil
        do
          local _232_0 = {state, b}
          if ((_G.type(_232_0) == "table") and (_232_0[1] == "base") and (_232_0[2] == 92)) then
            state0 = "backslash"
          elseif ((_G.type(_232_0) == "table") and (_232_0[1] == "base") and (_232_0[2] == 34)) then
            state0 = "done"
          elseif ((_G.type(_232_0) == "table") and (_232_0[1] == "backslash") and (_232_0[2] == 10)) then
      ...
      local function parse_string()
        ...
        local _236_0 = (rawget(_G, "loadstring") or load)(("return " .. formatted))
        if (nil ~= _236_0) then
          local load_fn = _236_0
          return dispatch(load_fn())
        elseif (_236_0 == nil) then
      ...
      local function parse_number(rawstr)
        ...
        if rawstr:match("^%d") then
          ...
          local _242_0 = tonumber(number_with_stripped_underscores)
          if (nil ~= _242_0) then
            local x = _242_0
            dispatch(x)
            return true
...
package.preload["fennel.view"] = package.preload["fennel.view"] or function(...)
  ...
  local function utf8_escape(str)
    local function validate_utf8(str0, index)
      ...
      code = (init and _83_())
      if (code and (function(_85_,_86_,_87_) return (_85_ <= _86_) and (_86_ <= _87_) end)(init["min-code"],code,init["max-code"]) and not ((55296 <= code) and (code <= 57343))) then
        return init.len
      end
    end
    local index = 1
  ...
  local function _96_(x, options, indent, colon_3f)
    ...
    local tv = type(x0)
    local function _99_()
      local _98_0 = getmetatable(x0)
      if (nil ~= _98_0) then
        return _98_0.__fennelview
      else
        return _98_0
      end
    end
    if ((tv == "table") or ((tv == "userdata") and _99_())) then
    ...
    elseif (tv == "number") then
      ...
      if ((tv == "string") and colon_string_3f(x0) and _101_()) then
        return (":" .. x0)
...
package.preload["fennel.utils"] = package.preload["fennel.utils"] or function(...)
  ...
  local len = nil
  do
    local _106_0, _107_0 = pcall(require, "utf8")
    if ((_106_0 == true) and (nil ~= _107_0)) then
      local utf8 = _107_0
      len = utf8.len
    else
      local _ = _106_0
  ...
  local function kvmap(t, f, _3fout)
    ...
    for k, x in stablepairs(t) do
      local _131_0, _132_0 = f0(k, x)
      if ((nil ~= _131_0) and (nil ~= _132_0)) then
        local key = _131_0
        local value = _132_0
        out[key] = value
      elseif (nil ~= _131_0) then
        local value = _131_0
  ...
  local function member_3f(x, tbl, _3fn)
    local _135_0 = tbl[(_3fn or 1)]
    if (_135_0 == x) then
      return true
    elseif (_135_0 == nil) then
      return nil
    else
      local _ = _135_0
  ...
  getenv = ((os and os.getenv) or _145_)
  ...
  local function sym(str, _3fsource)
    ...
    return setmetatable(_146_, symbol_mt)
  end
  nil_sym = sym("nil")
  local function sequence(...)
    local function _149_(seq, view0, inspector, indent)
      local opts = nil
      do
    ...
    return setmetatable({...}, {__fennelview = _149_, sequence = sequence_marker})
  end
  local function expr(strcode, etype)
    return setmetatable({strcode, type = etype}, expr_mt)
  end
  local function comment_2a(contents, _3fsource)
    local _150_ = (_3fsource or {})
    local filename = _150_["filename"]
    local line = _150_["line"]
  ...
  local function varg(_3fsource)
    ...
    return setmetatable(_151_, varg_mt)
  end
...
local function eval(str, options, ...)
  ...
  loader = specials["load-code"](lua_source, env, _709_(...))
  opts.filename = nil
  return loader(...)
end
...
local function syntax()
  ...
  for k, v in pairs(_G) do
    local _710_0 = type(v)
    if (_710_0 == "function") then
      out[k] = {["function?"] = true, ["global?"] = true}
    elseif (_710_0 == "table") then
...
do
  ...
  package.preload[module_name] = _713_
  _ = nil
  local env = nil
  do
    local _714_0 = specials["make-compiler-env"](nil, compiler.scopes.compiler, {})
    _714_0["utils"] = utils
    _714_0["fennel"] = mod
    env = _714_0
  end
