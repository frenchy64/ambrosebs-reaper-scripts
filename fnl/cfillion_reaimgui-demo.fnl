...
(fn demo.ShowDemoWindow [open]
  ...
  (when show-app.style_editor
    (when (doimgui show-app.style_editor (ImGui.Begin ctx "Dear ImGui Style Editor" true))
  ...
  (when (doimgui open (ImGui.Begin ctx "Dear ImGui Demo" $ window-flags))
